...
public class FraccionTest1Suma {
    
    private Fraccion frac1;
    private Fraccion frac2;
    private Fraccion frac3;

    public FraccionTest1Suma(int num1, int den1, int num2, int den2, int num3, int den3) {
    ...
    public void testSuma() {
        ...
        Fraccion resultado = Fraccion.sumar(frac1, frac2);
