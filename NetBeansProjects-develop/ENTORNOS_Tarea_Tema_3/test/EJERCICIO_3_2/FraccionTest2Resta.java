...
public class FraccionTest2Resta {
    
    private Fraccion frac1;
    private Fraccion frac2;
    private Fraccion frac3;

    public FraccionTest2Resta(int num1, int den1, int num2, int den2, int num3, int den3) {
 ...
 @Test
    public void testSuma() {
        ...
        Fraccion resultado = Fraccion.restar(frac1, frac2);
